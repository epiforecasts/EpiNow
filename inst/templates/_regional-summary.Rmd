...
latest_date <- here:here(file.path(summary_path, "latest_date.rds"))
```
...
<br>
`r paste0("*Table 2: Latest estimates (as of the ", latest_date, ") of the number of cases by date of infection, the effective reproduction number, and the doubling time in each region. The 90% credible interval is shown.*")`
