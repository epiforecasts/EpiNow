...
```{r summarise-bigr-plot, fig.height = 6, fig.width = 8, layout="l-body-outset"}
...
```{r summarise-cases-plot, fig.height = 6, fig.width = 8, layout="l-body-outset"}
...
```{r bigr-plot, fig.height = 12, fig.width = 8, layout="l-body-outset"}
...
```{r cases-plot, fig.height = 12, fig.width = 8, layout="l-body-outset"}
