...
<br>
`r paste0("*Figure ",  summary_figures + 1 + (index - 1) * 2, ": A.) Cases by date of report (bars) and their estimated date of infection. B.) Time-varying estimate of the effective reproduction number. Light grey ribbon = 90% credible interval. Estimates are shown until the ", latest_date,  ".Dark grey ribbon = 50% credible interval. Confidence in the estimated values is indicated by shading with reduced shading corresponding to reduced confidence.*")`
